...
public class BuilderOptionsMenuStart : IBuilderMenuStart
{
    ...
    public BuilderOptionsMenuStart()
    {
        _data = Resources.Load<OptionStartTextAndIcon>("ScriptableObject/UI/OptionsStart/MenuStartOptionsData");
